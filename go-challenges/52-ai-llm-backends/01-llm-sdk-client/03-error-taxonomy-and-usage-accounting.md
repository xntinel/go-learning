...
```bash
mkdir -p go-solutions/52-ai-llm-backends/01-llm-sdk-client/03-error-taxonomy-and-usage-accounting/cmd/demo
cd go-solutions/52-ai-llm-backends/01-llm-sdk-client/03-error-taxonomy-and-usage-accounting
