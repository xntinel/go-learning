...
```bash
mkdir -p ~/go-exercises/gen/internal/integer ~/go-exercises/gen/internal/fib ~/go-exercises/gen/internal/compose ~/go-exercises/gen/cmd/gendemo
cd ~/go-exercises/gen
go mod init example.com/gen
```
