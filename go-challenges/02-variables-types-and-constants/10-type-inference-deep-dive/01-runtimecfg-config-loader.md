...
```bash
mkdir -p go-solutions/02-variables-types-and-constants/10-type-inference-deep-dive/01-runtimecfg-config-loader/cmd/demo
cd go-solutions/02-variables-types-and-constants/10-type-inference-deep-dive/01-runtimecfg-config-loader
go mod edit -go=1.26
```
