...
```bash
mkdir -p go-solutions/03-control-flow/06-labels-break-continue-goto/04-worker-fanin-graceful-drain/cmd/demo
cd go-solutions/03-control-flow/06-labels-break-continue-goto/04-worker-fanin-graceful-drain
go mod edit -go=1.24
```
