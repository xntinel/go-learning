...
```bash
mkdir -p go-solutions/03-control-flow/08-panic-and-recover/24-streaming-json-recovery/cmd/demo
cd go-solutions/03-control-flow/08-panic-and-recover/24-streaming-json-recovery
go mod edit -go=1.24
```
