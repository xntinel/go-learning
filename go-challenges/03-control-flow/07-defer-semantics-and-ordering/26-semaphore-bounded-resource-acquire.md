...
```bash
mkdir -p ~/go-exercises/semaphore-bounded-resource-acquire/cmd/demo
cd ~/go-exercises/semaphore-bounded-resource-acquire
go mod init example.com/semaphore-bounded-resource-acquire
go mod edit -go=1.24
```
