...
```bash
mkdir -p ~/go-exercises/bloom-filter-dynamic-hashfunc-finalization/cmd/demo
cd ~/go-exercises/bloom-filter-dynamic-hashfunc-finalization
go mod init example.com/bloom-filter-dynamic-hashfunc-finalization
go mod edit -go=1.24
```
