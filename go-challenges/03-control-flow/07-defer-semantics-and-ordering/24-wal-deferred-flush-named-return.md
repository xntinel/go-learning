...
```bash
mkdir -p ~/go-exercises/wal-deferred-flush-named-return/cmd/demo
cd ~/go-exercises/wal-deferred-flush-named-return
go mod init example.com/wal-deferred-flush-named-return
go mod edit -go=1.24
```
