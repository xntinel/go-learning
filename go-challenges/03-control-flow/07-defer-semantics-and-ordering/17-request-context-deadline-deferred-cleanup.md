...
```bash
mkdir -p ~/go-exercises/request-context-deadline-deferred-cleanup/cmd/demo
cd ~/go-exercises/request-context-deadline-deferred-cleanup
go mod init example.com/request-context-deadline-deferred-cleanup
go mod edit -go=1.24
```
