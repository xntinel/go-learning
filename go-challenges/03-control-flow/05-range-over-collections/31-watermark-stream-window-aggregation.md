...
```bash
mkdir -p ~/go-exercises/watermark-stream-window-aggregation/cmd/demo
cd ~/go-exercises/watermark-stream-window-aggregation
go mod init example.com/watermark-stream-window-aggregation
go mod edit -go=1.24
```
