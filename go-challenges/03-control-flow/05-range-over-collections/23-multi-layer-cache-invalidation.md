...
```bash
mkdir -p ~/go-exercises/multi-layer-cache-invalidation/cmd/demo
cd ~/go-exercises/multi-layer-cache-invalidation
go mod init example.com/multi-layer-cache-invalidation
go mod edit -go=1.24
```
