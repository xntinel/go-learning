...
```bash
mkdir -p ~/go-exercises/sliding-window-rate-limiter-log/cmd/demo
cd ~/go-exercises/sliding-window-rate-limiter-log
go mod init example.com/sliding-window-rate-limiter-log
go mod edit -go=1.24
```
