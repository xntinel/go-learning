...
```bash
mkdir -p ~/go-exercises/connection-pool-lru-eviction/cmd/demo
cd ~/go-exercises/connection-pool-lru-eviction
go mod init example.com/connection-pool-lru-eviction
go mod edit -go=1.24
```
