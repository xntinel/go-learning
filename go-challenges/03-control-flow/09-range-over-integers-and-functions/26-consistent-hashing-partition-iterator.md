...
```bash
mkdir -p go-solutions/03-control-flow/09-range-over-integers-and-functions/26-consistent-hashing-partition-iterator/cmd/demo
cd go-solutions/03-control-flow/09-range-over-integers-and-functions/26-consistent-hashing-partition-iterator
go mod edit -go=1.24
```
