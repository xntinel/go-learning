...
```bash
mkdir -p ~/go-exercises/hierarchical-token-quota-manager/cmd/demo
cd ~/go-exercises/hierarchical-token-quota-manager
go mod init example.com/hierarchical-token-quota-manager
go mod edit -go=1.24
```
