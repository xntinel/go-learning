...
```bash
mkdir -p ~/go-exercises/write-ahead-log-compaction-iterator/cmd/demo
cd ~/go-exercises/write-ahead-log-compaction-iterator
go mod init example.com/write-ahead-log-compaction-iterator
go mod edit -go=1.24
```
