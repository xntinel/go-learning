...
```bash
mkdir -p ~/go-exercises/dns-resolution-record-dispatch/cmd/demo
cd ~/go-exercises/dns-resolution-record-dispatch
go mod init example.com/dns-resolution-record-dispatch
go mod edit -go=1.24
```
