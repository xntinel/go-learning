...
```bash
mkdir -p ~/go-exercises/connection-pool-route-selection/cmd/demo
cd ~/go-exercises/connection-pool-route-selection
go mod init example.com/connection-pool-route-selection
go mod edit -go=1.24
```
