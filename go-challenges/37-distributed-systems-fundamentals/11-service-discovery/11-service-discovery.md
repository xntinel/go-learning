...
```bash
mkdir -p ~/go-exercises/servicediscovery/registry
mkdir -p ~/go-exercises/servicediscovery/cmd/demo
cd ~/go-exercises/servicediscovery
go mod init example.com/servicediscovery
```
