...
```bash
mkdir -p go-solutions/06-collections-arrays-slices-and-maps/13-implementing-a-ring-buffer/04-thread-safe-ring-mutex/cmd/demo
cd go-solutions/06-collections-arrays-slices-and-maps/13-implementing-a-ring-buffer/04-thread-safe-ring-mutex
go mod edit -go=1.24
```
