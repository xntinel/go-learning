...
```bash
mkdir -p go-solutions/06-collections-arrays-slices-and-maps/11-slice-memory-leaks/09-weak-canonicalization-cache/cmd/demo
cd go-solutions/06-collections-arrays-slices-and-maps/11-slice-memory-leaks/09-weak-canonicalization-cache
go mod edit -go=1.24
```
