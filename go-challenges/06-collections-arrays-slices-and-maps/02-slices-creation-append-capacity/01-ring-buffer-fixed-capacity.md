...
```bash
mkdir -p go-solutions/06-collections-arrays-slices-and-maps/02-slices-creation-append-capacity/01-ring-buffer-fixed-capacity/cmd/demo
cd go-solutions/06-collections-arrays-slices-and-maps/02-slices-creation-append-capacity/01-ring-buffer-fixed-capacity
go mod edit -go=1.26
```
