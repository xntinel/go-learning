...
```bash
mkdir -p go-solutions/10-error-handling/08-panic-vs-error/09-assert-panics-testing-helper/cmd/demo
cd go-solutions/10-error-handling/08-panic-vs-error/09-assert-panics-testing-helper
go mod edit -go=1.26
```
