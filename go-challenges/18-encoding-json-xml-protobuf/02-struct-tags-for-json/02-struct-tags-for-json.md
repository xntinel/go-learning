...
```bash
mkdir -p ~/go-exercises/apiresponse/internal/response
mkdir -p ~/go-exercises/apiresponse/cmd/demo
cd ~/go-exercises/apiresponse
go mod init example.com/apiresponse
```
