...
```bash
mkdir -p go-solutions/04-functions/08-init-functions-and-package-initialization/18-feature-flag-table-consistency-check/cmd/demo
cd go-solutions/04-functions/08-init-functions-and-package-initialization/18-feature-flag-table-consistency-check
go mod edit -go=1.24
```
