...
```bash
mkdir -p go-solutions/04-functions/08-init-functions-and-package-initialization/31-webhook-event-schema-registration-table/cmd/demo
cd go-solutions/04-functions/08-init-functions-and-package-initialization/31-webhook-event-schema-registration-table
go mod edit -go=1.24
```
