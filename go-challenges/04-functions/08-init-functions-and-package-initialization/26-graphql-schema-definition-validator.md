...
```bash
mkdir -p go-solutions/04-functions/08-init-functions-and-package-initialization/26-graphql-schema-definition-validator/cmd/demo
cd go-solutions/04-functions/08-init-functions-and-package-initialization/26-graphql-schema-definition-validator
go mod edit -go=1.24
```
