...
```bash
mkdir -p go-solutions/04-functions/06-function-types-and-callbacks/24-auth-validator-callback-chain/cmd/demo
cd go-solutions/04-functions/06-function-types-and-callbacks/24-auth-validator-callback-chain
go mod edit -go=1.24
```
