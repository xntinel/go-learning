...
```bash
mkdir -p ~/go-exercises/auth-validator-callback-chain/cmd/demo
cd ~/go-exercises/auth-validator-callback-chain
go mod init example.com/auth-validator-callback-chain
go mod edit -go=1.24
```
