...
```bash
mkdir -p ~/go-exercises/grpc-interceptor-chain-composition/cmd/demo
cd ~/go-exercises/grpc-interceptor-chain-composition
go mod init example.com/grpc-interceptor-chain-composition
go mod edit -go=1.24
```
