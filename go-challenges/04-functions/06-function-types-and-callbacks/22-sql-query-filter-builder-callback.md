...
```bash
mkdir -p ~/go-exercises/sql-query-filter-builder-callback/cmd/demo
cd ~/go-exercises/sql-query-filter-builder-callback
go mod init example.com/sql-query-filter-builder-callback
go mod edit -go=1.24
```
