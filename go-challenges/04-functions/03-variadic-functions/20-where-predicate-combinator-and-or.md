...
```bash
mkdir -p go-solutions/04-functions/03-variadic-functions/20-where-predicate-combinator-and-or/cmd/demo
cd go-solutions/04-functions/03-variadic-functions/20-where-predicate-combinator-and-or
go mod edit -go=1.24
```
