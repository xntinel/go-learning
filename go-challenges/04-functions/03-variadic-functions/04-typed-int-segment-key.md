...
```bash
mkdir -p go-solutions/04-functions/03-variadic-functions/04-typed-int-segment-key/cmd/demo
cd go-solutions/04-functions/03-variadic-functions/04-typed-int-segment-key
go mod edit -go=1.25
```
