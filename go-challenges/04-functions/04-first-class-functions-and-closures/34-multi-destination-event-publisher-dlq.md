...
```bash
mkdir -p ~/go-exercises/multi-destination-publisher/cmd/demo
cd ~/go-exercises/multi-destination-publisher
go mod init example.com/multi-destination-publisher
go mod edit -go=1.24
```
