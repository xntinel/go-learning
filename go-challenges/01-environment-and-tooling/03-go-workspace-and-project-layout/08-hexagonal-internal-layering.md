...
```bash
mkdir -p ~/go-exercises/service/internal/core ~/go-exercises/service/internal/adapters ~/go-exercises/service/internal/platform ~/go-exercises/service/cmd/server ~/go-exercises/service/cmd/demo
